  ...
  <div class="rooms-card">
    <div class="rooms-card__wrap">
      <div class="rooms-card__col">
        <Gallery contain-first class="rooms-card__gallery" :images="gallery" />
        ...
        <div class="rooms-card__complex">
          <div class="rooms-card__complex-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
              <path d="M10.3164 4.49976H11.0532V5.24976H10.3164V4.49976Z" fill="white" />
              <path d="M10.3164 6.00024H11.0532V6.75024H10.3164V6.00024Z" fill="white" />
              <path d="M10.3164 7.5H11.0532V8.25H10.3164V7.5Z" fill="white" />
              <path d="M10.3164 8.99976H11.0532V9.74976H10.3164V8.99976Z" fill="white" />
              <path d="M10.3164 11.9998H11.0532V12.7498H10.3164V11.9998Z" fill="white" />
              <path d="M10.3164 10.5002H11.0532V11.2502H10.3164V10.5002Z" fill="white" />
              <path d="M4.42188 4.49976H5.15872V5.24976H4.42188V4.49976Z" fill="white" />
              <path d="M4.42188 6.00024H5.15872V6.75024H4.42188V6.00024Z" fill="white" />
              <path d="M4.42188 7.5H5.15872V8.25H4.42188V7.5Z" fill="white" />
              <path d="M4.42188 8.99976H5.15872V9.74976H4.42188V8.99976Z" fill="white" />
              <path d="M4.42188 11.9998H5.15872V12.7498H4.42188V11.9998Z" fill="white" />
              <path d="M4.42188 10.5002H5.15872V11.2502H4.42188V10.5002Z" fill="white" />
              <path d="M2.94727 4.49976H3.68411V5.24976H2.94727V4.49976Z" fill="white" />
              <path d="M2.94727 6.00024H3.68411V6.75024H2.94727V6.00024Z" fill="white" />
              <path d="M2.94727 7.5H3.68411V8.25H2.94727V7.5Z" fill="white" />
              <path d="M2.94727 8.99976H3.68411V9.74976H2.94727V8.99976Z" fill="white" />
              <path d="M2.94727 11.9998H3.68411V12.7498H2.94727V11.9998Z" fill="white" />
              <path d="M2.94727 10.5002H3.68411V11.2502H2.94727V10.5002Z" fill="white" />
              <path d="M5.89453 4.49976H6.63137V5.24976H5.89453V4.49976Z" fill="white" />
              <path d="M5.89453 6.00024H6.63137V6.75024H5.89453V6.00024Z" fill="white" />
              <path d="M5.89453 7.5H6.63137V8.25H5.89453V7.5Z" fill="white" />
              <path d="M5.89453 8.99976H6.63137V9.74976H5.89453V8.99976Z" fill="white" />
              <path d="M5.89453 11.9998H6.63137V12.7498H5.89453V11.9998Z" fill="white" />
              <path d="M5.89453 10.5002H6.63137V11.2502H5.89453V10.5002Z" fill="white" />
              <path
